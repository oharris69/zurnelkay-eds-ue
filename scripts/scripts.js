/*
 * Boilerplate scaffold retains intentional imperative patterns (labelled loops
 * with continue, sequential awaits, hoisted helpers). Disable the airbnb
 * stylistic rules that flag them here rather than restructuring working code.
 */
/* eslint-disable no-continue, no-await-in-loop, no-restricted-syntax */
/* eslint-disable no-use-before-define, no-shadow, no-console, import/no-cycle */
import {
  loadHeader,
  loadFooter,
...
/*
  ...
  for (const block of videoBlocks) {
    ...
    if (isDMPlayerUrl) {
      ...
      iframeWrapper.style.cssText = 'position: relative; width: 100%; padding-bottom: 56.25%;'
      ...
      iframe.style.cssText = 'position: absolute; top: 0; left: 0; width: 100%;'
        + ' height: 100%; border: 0;';
